...
function preload() {
    var assets = {
        spritesheet: {
            birdie: ['assets/cocoabutteristhekey/assets/images/vv.png', 33, 24],
            clouds: ['assets/cocoabutteristhekey/assets/images/clouds.png', 128, 64]
        },
        image: {
            key: ['assets/cocoabutteristhekey/assets/images/key.png'],
            cocoabutter: ['assets/cocoabutteristhekey/assets/images/cocoabutter.png'],
            ocean: ['assets/cocoabutteristhekey/assets/images/ocean.png']
        },
        audio: {
            flap: ['assets/cocoabutteristhekey/assets/audio/jetskinoises.mp3', 'assets/cocoabutteristhekey/assets/audio/flap.ogg'],
            score: ['assets/cocoabutteristhekey/assets/audio/blessup.mp3', 'assets/cocoabutteristhekey/assets/audio/score.ogg'],
            hurt: ['assets/cocoabutteristhekey/assets/audio/hurt.mp3', 'assets/cocoabutteristhekey/assets/audio/hurt.ogg'],
            anotherone: ['assets/cocoabutteristhekey/assets/audio/anotherone.mp3'],
            jetski: ['assets/cocoabutteristhekey/assets/audio/jetski.mp3']
        }
    };
